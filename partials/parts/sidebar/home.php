...
<div class="min-w-80">
	<div class="fixed min-w-80 bg-white/10 backdrop-blur-lg right-0 h-full px-5">
		...
		<div class="grid gap-2 mt-4">
			<?php foreach ( $home_page_sidebar_menu as $index => $menu_item ) : ?>
				<a href="<?php echo $menu_item->url ?>"
				   class="p-4 flex gap-1 bg-white/15 group transition-colors hover:bg-red-900 rounded-2xl items-center">
					<div>
