(() => {
  ...
  // assets/js/modules/category-dropdown.js
  function categoryDropdown() {
    ...
    dropDownGroup.forEach((categoryDropDown) => {
      ...
      select.addEventListener("change", (event2) => {
        if (event2.target.value === baseArchive.value) {
  ...
  function plyr() {
    var _a;
    (_a = document.querySelectorAll(".plyr-js")) == null ? void 0 : _a.forEach((el) => {
  ...
  // assets/js/modules/image-card.js
  ...
  function singleVideo() {
    const playBtnGroup = document.querySelectorAll(".single-video .playBtn");
        ...
        jQuery(($) => {
          $.ajax({
            ...
            data: {
              ...
              acfField: playBtn.dataset.acfFiled
            },
            success: (res) => {
              popupBackdrop.dataset.status = "done";
              popupBackdropContent.innerHTML = res.innerHTML;
